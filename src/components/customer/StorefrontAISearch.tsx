...
export function StorefrontAISearch({ onSelectProduct, onOpenCart }: StorefrontAISearchProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-8 py-10 space-y-12 animate-fadeIn">
      ...
      {/* Product Cards Grid (3 cards row matching Screen 4) or Honest Zero State */}
      {filteredRecommendations.length === 0 ? (
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-12 text-center max-w-xl mx-auto space-y-4">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            No published products in the store match your specific criteria for <span className="font-semibold text-slate-900">"{searchQuery}"</span>.
          </p>
          <p className="text-xs text-slate-500">
            Try adjusting your budget, using broader search terms, or exploring available categories.
          </p>
        </div>
      ) : (
