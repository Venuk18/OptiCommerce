...
export function CustomerHome({ onSelectProduct, onOpenCart }: CustomerHomeProps) {
  ...
  // Specific items for home showcase
  const tailoredProducts = [
    products.find(p => p.id === 'zenpods-pro') || products[0],
    products.find(p => p.id === 'prod-laptop-1') || products[1],
    products.find(p => p.id === 'prod-display-1') || products[2],
  ].filter(Boolean) as Product[];

  const deskBundleProduct = products.find(p => p.id === 'prod-desk-bundle') || products[3] || products[0];
  const fastChargeProduct = products.find(p => p.id === 'prod-charge-1') || products[4] || products[1];
  const luminaLampProduct = products.find(p => p.id === 'prod-lamp-1') || products[5] || products[2];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-16 pb-14 px-4 sm:px-8 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <p className="text-sm sm:text-base text-slate-600 max-w-2xl mx-auto font-normal">
            Our AI assistant understands your needs. Just ask or browse our smart collection.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8 py-10 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          {/* Left Hero Card: ErgoPro Desk Setup Kit */}
          <div 
          ...
          {/* Right Column: 2 Mini Feature Cards */}
          <div className="grid grid-cols-1 gap-6">
            {/* FastCharge Pro Station */}
            <div
            ...
            >
              ...
              <div className="mt-4 space-y-1">
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  {fastChargeProduct.description.split('.')[0]}.
                </p>
              </div>
            ...
            >
              ...
              <div className="mt-4 space-y-1">
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  {luminaLampProduct.description.split('.')[0]}.
                </p>
              </div>
